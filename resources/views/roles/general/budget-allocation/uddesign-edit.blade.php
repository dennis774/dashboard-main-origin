...
<head>
    ...
    <title>Edit UdDesign Budget Allocation</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mt-4 d-flex justify-content-center ">
                <h3 class="targetHeader">Edit UdD Budget Allocation</h3>
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <form action="{{ route('uddesign-target.update', ['uddesign_target' => $uddesignBudget->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-3">
                        <label for="amount">Amount</label>
                        <input type="number" name="amount" id="amount" class="form-control" value="{{ $uddesignBudget->amount }}" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="start_date">Start Date</label>
                        <input type="date" name="start_date" id="start_date" class="form-control" value="{{ $uddesignBudget->start_date->format('Y-m-d') }}" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="end_date">End Date</label>
                        <input type="date" name="end_date" id="end_date" class="form-control" value="{{ $uddesignBudget->end_date->format('Y-m-d') }}" required>
                    </div>
