                    ...
                    <div class="row">
                        <div class="col-lg-9 prediction">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-7" style="color: white;">
                                   ...
                                   <div class="col-lg-12">
                                    <div class="customDeals p-2" style="height: 185px;">
                                        <div class="row justify-content-between text-center">
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="font-size: 15px;">
                                                <div class="d-flex align-items-center justify-content-center"><b>Open</b></div>
                                                <p class="d-flex align-items-center justify-content-center">09</p>
                                            </div>
                                    
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="font-size: 15px;">
                                                <div class="d-flex align-items-center justify-content-center">Processing</div>
                                                
                                            </div>
                                    
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="font-size: 15px;">
                                                <div class="d-flex align-items-center justify-content-center">Closed</div>
                                            </div>
                                    
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="font-size: 15px;">
                                                <div class="d-flex align-items-center justify-content-center">On-Hold</div>
                                            </div>
                                    
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="font-size: 15px;">
                                                <div class="d-flex align-items-center justify-content-center">Cancel</div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-3 forecast text-white text">
                            ...
                            <div class="col-lg-12 d-flex justify-content-end">
                                <a href="{{route('general.executive.page1')}}" class="text-white text">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
