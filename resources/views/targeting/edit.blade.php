...
<body>
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <form action="{{ route('targeting.update', $targeting) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-3">
                        <label for="amount">Amount</label>
                        <input type="number" name="amount" id="amount" class="form-control" value="{{ $targeting->amount }}" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="start_date">Start Date</label>
                        <input type="date" name="start_date" id="start_date" class="form-control" value="{{ $targeting->start_date->format('Y-m-d') }}" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="end_date">End Date</label>
                        <input type="date" name="end_date" id="end_date" class="form-control" value="{{ $targeting->end_date->format('Y-m-d') }}" required>
                    </div>
