        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mt-4 d-flex justify-content-center">
                    <h2 class="mb-4" style="color: #fff;">Create Promo</h2>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="dishes_available" id="dishes_available" class="form-control custom-input" required />
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="sales_before" id="sales_before" class="form-control custom-input" required />
                                        </div>
                                        <div class="mb-3">
                                            <label for="sales_after" class="form-label text-white">Sales After Promo:</label>
                                            <input type="number" name="sales_after" id="sales_after" class="form-control custom-input" required />
                                        </div>
                                        <div class="mb-3">
                                            <label for="start_date" class="form-label text-white">Start Date:</label>
                                            <input type="date" name="start_date" id="start_date" class="form-control custom-input" required />
                                        </div>
                                        <div class="mb-3">
                                            <label for="end_date" class="form-label text-white">End Date:</label>
                                            <input type="date" name="end_date" id="end_date" class="form-control custom-input" required />
                                        </div>
                                    </div>
                                </div>
