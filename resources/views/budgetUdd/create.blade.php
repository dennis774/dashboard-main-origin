    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mt-4 ">
                <a href="{{ route('targeting.index') }}"><i class="fa-solid fa-arrow-left backTarget"></i></a>
            </div>
            <div class="col-lg-4 mt-4 d-flex justify-content-center ">
                <h3 class="targetHeader">Budget Allocation</h3>
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-12 d-flex justify-content-center">
                <h3 class="createHeader">Uddesign</h3>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-lg-3"></div>
            <div class="col-lg-6">
                <form action="{{ route('budgetUdd.store') }}" method="POST">
                    @csrf
